...
gmx grompp -f waterGenConfig.mdp -c water.gro -n water.ndx -p water.top -o GenConfig.tpr
gmx mdrun -v -deffnm GenConfig

# retrieve output
pbsdcp -g $TMPDIR/'GenConfig.*' $OUT
